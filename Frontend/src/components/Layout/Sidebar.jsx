...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div className="h-full flex flex-col">
        {/* User Profile Section - Show in both states */}
        <div className="flex-shrink-0 px-3 pt-4 pb-3 border-b border-gray-200">
          {isSidebarOpen ? (
            ...
            // Collapsed profile view - just the avatar
            <div className="flex items-center justify-center">
              <div className="w-10 h-10 bg-gradient-to-br from-gray-600 to-gray-800 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-md cursor-pointer hover:scale-105 transition-transform">
                V
              </div>
            </div>
          )}
